...
public:
	...
	//Lek 
	inline void enableDefaultARF(int a,int b,int c) { arf = new Arf(a,b,c); }
	void setSINR(double d, double d1);
	//	inline void setSINR(double d, double d1) { SINR = d/d1;}
	inline double getSINR() {return SINR;}
protected:
