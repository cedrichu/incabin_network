...
/* 11p -- Fan paper in Dropbox folder   
const struct ModulationParam modulation_table[8] = {
//  mod  name  SINRdB   SINR  NDBPS bit
  { 0, "BPSK", 5, 3.1623, 24 }, {1, "BPSK", 6, 3.9811, 36} ,
  { 2, "QPSK", 8, 6.3096, 48 }, {3, "QPSK", 10, 10.0, 72}, 
  { 4, "QAM16", 13, 19.9526, 96}, {5, "QAM16", 15, 31.6228, 144},
  { 6, "QAM64", 20, 100.0, 192 }, { 7, "QAM64", 30, 1000.0, 216 } };  
*/
/* 11a -- stardard  */
const struct ModulationParam modulation_table[8] = {
//  mod  name  SINRdB   SINR  NDBPS bit
  { 0, "BPSK", 6.02, 3.9994, 24 }, {1, "BPSK", 7.78, 5.9979, 36} ,
  { 2, "QPSK", 9.03, 7.9983, 48 }, {3, "QPSK", 10.79, 11.9950, 72}, 
  { 4, "QAM16", 17.04, 50.5825, 96}, {5, "QAM16", 18.80, 78.8578, 144},
  { 6, "QAM64", 24.05, 254.0973, 192 }, { 7, "QAM64", 24.56, 285.7591, 216 } }; 
