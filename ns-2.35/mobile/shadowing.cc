...
Shadowing::Shadowing()
{
	...
	fprintf(stderr,"std_db %f dist0_ %f PL %f seed %d\n",std_db_,dist0_,pathlossExp_,seed_);
	ranVar = new RNG;
...
double Shadowing::Pr(PacketStamp *t, PacketStamp *r, WirelessPhy *ifp)
{
	...
	fprintf(stderr,"Pr0 %f txPr %f %f\n",10*log10(Pr0),t->getTxPr(),10*log10(Pr));
	return Pr;
}
